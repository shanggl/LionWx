...
<head>
    ...
    <script type="text/javascript">
        ...
        function beforeSubmit(){
            $.messager.confirm("确认发送付款码","确认发送付款码给用户吗?",function () {

                $.ajax({
                    type:'POST',
                    url:'smpPayCashJnlController.do?doAddQrPay',
                    data:$("#qrPayForm").serialize(),
                    timeout:5000,
                    ...
                    error:function(xhr,type){tip("发送付款码给用户失败");}
                });
...
<body>
<t:formvalid formid="qrPayForm" dialog="true" usePlugin="password" layout="table" action="" tiptype="1">
    <table style="width:800px;" cellpadding="0" cellspacing="1" class="formtable">
        ...
        <tr>
            <td align="right">
                <label class="Validform_label">语言</label>
            </td>
            <td class="value">
                <input id="langcn" name="lang" value="cn" ></input>
                <input id="langru" name="lang" value="ru" ></input>
            </td>
        </tr>
