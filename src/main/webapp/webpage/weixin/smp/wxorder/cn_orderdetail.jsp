					...
					<div class="weui-cell">
						...
						<div class="weui-cell__bd">
							<input name="senderPhone" id="sender_phone" class="weui-input"
								type="tel" placeholder="请输入手机号" required emptyTips="手机号" value="${ORDER.getSenderPhone()} " />
						</div>
					</div>
				</div>
				<div class="weui-cells">
					...
					<div class="weui-cell">
						...
						<div class="weui-cell__bd">
							<input name="destName" id="dest_name" class="weui-input"
								type="text" placeholder="请输入收件人姓名" required emptyTips="请输入收件人姓名" value="${ORDER.getDestName() }"/>
						</div>
					</div>
					<div class="weui-cell">
						<div class="weui-cell__hd">
						...
						<div class="weui-cell__bd">
							<input name="destPhone" id="dest_phone" class="weui-input"
								type="tel" placeholder="请输入收件人电话" required emptyTips="请输入收件人电话" value="${ORDER.getDestPhone() }"/>
						</div>
					</div>
				</div>
				<div class="weui-cells">
					...
					<div class="weui-cell">
						...
						<div class="weui-cell__bd">
							<input name="destForeignCity" id="dest_city" class="weui-input"
								type="text" placeholder="请输入城市名" 　required emptyTips="请输入城市名称" value="${ORDER.getDestForeignCity() }" />
						</div>
					</div>
					<div class="weui-cell">
						<div class="weui-cell__hd">
						...
						<div class="weui-cell__bd">
							<input name="destCityPostcode" id="dest_city_postcode"
								...
								emptyTips="请输入城市邮编" value="${ORDER.getDestCityPostcode() }" />
						</div>
					</div>
					<div class="weui-cell">
						<div class="weui-cell__hd">
						...
						<div class="weui-cell__bd">
							<input name="destForeignAddr" id="dest_foreigin_addr"
								...
								emptyTips="请输入详细地址" value="${ORDER.getDestForeignAddr() }" />
						</div>
					</div>
				</div>
						...
						<div class="weui-cell__hd">
							...
							<p>
								<input name="localOrderNo" id="orderId" required class="weui-input"
									type="number" placeholder="国内快递单号"　 value="${ORDER.getLocalOrderNo() }" />
							</p>
						</div>
					...
					<div class="weui-cell">
						...
						<div class="weui-cell__bd">
							<input name="packageValue" id="package_value" class="weui-input"
								type="number" placeholder="保价" value="${ORDER.getPackageValue() }"/>
						</div>
						<div class="weui-cell__ft"></div>
					</div>
