...
<link href="../plug-in/weixin/mobru.css" type="text/css"
	rel="stylesheet"></link>
...
<body>
	...
	<form name="form1" action="wxuserorder.do?qrquery&lang=ru"
		method="post">
					...
					<td>
						<div align="right">
							<input name="localOrderNo" id="orderId" class="content-padded"
								placeholder="Запить номер заказа посылки" style="width: 100%;" type="number"></input>
						</div>
					</td>
					<td><div align="left">
							<a href="javascript:scanQRbar();"> <img
								src="../plug-in/weixin/img/smp/scanqr1.png"
								class="content-padded" height="30px" /></a>
						</div>
					</td>
				</tr>
			</tbody>
		...
		<div class="weui-btn-area">
			<input value="следить" class="weui-btn weui-btn_primary" type="submit"></input>
		</div>
	</form>
